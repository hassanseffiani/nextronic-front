...
export default {
  props: ["dayAnalytics"],
  data() {
    console.log(this.dayAnalytics)
    return {
      source1: {
        series: [
          {
            data: [28, 32, 27, 34, 27, 30, 29, 27, 26, 29, 31, 30, 28, 29, 27, 26, 25, 29, 28, 30, 31, 29, 29, 28]
      ...
      source2: {
        series: [
          {
            data: [26, 28, 27, 29, 27, 25, 28, 30, 31, 28, 27, 27, 28, 30, 29, 28, 29, 31, 29, 27, 26, 28, 30]
          }
        ],
        chartOptions: {
          chart: {
