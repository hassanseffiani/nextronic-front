...
export default {
  ...
  data() {
    return {
      devices: [
        {
          Date: "31/05/2021 11:30",
          City: "Casablanca",
          LocalT: "Data Center Casablanca",
          Type: "Temperature",
          Description: "Temperature elevee"
        },
        {
          Date: "31/05/2021 11:40",
          City: "Casablanca",
          LocalT: "Data Center Casablanca",
          Type: "Temperature",
          Description: "Temperature elevee"
      ...
      fields: [
        ...
        { key: "LocalT", sortable: false, label: "Local Technique" },
