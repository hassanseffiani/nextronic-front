  ...
  data() {
    return {
      series: [
        {
          name: "Temperature",
          data: [12, 32, 10, 15, 20, 32,12, 32, 10, 15, 20, 32,12, 32, 10, 15, 20, 32,12, 32, 10, 15, 20, 32],
        },
        {
          name: "Humidity",
          data: [18, 12, 25, 25, 15, 20, 18, 12, 25, 25, 15, 20, 18, 12, 25, 25, 15, 20, 18, 12, 25, 25, 15, 20],
        },
      ],
      chartOptions: {
        chart: {
...
<template>
  <div class="card">
    <div class="card-body">
      ...
      <h4 class="card-title mb-4">Temperature/Humidity Analytics</h4>
      <apexchart
        type="area"
        height="182"
