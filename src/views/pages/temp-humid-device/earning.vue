...
<template>
  <div class="card">
    <div class="card-body">
      ...
      <!-- <h4 class="card-title mb-4">Humidity Devices Status</h4> -->
        ...
        <div class="row">
          <div class="col-sm-6">
            <div>
              ...
              <p class="text-muted text-truncate mb-2">Min. Temperature</p>
              <h5 class="mb-0">26°C</h5>
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="mt-5 mt-sm-0">
              ...
              <p class="text-muted text-truncate mb-2">Max. Temperature</p>
              <h5 class="mb-0">33°C</h5>
            </div>
          </div>
        </div>
      </div>
